...
public class NoteActivity extends AppCompatActivity {
    ...
    public static final String NOTE_POSITION ="com.note.rakesh.notekeep.NOTE_POSITION";
    public static final String ORIGINAL_NOTE_COURSE_ID="com.note.rakesh.notekeep.ORIGINAL_NOTE_COURSE_ID";
    public static final String ORIGINAL_NOTE_TITLE="com.note.rakesh.notekeep.ORIGINAL_NOTE_TITLE";
    public static final String ORIGINAL_NOTE_TEXT="com.note.rakesh.notekeep.ORIGINAL_NOTE_TEXT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerCourses = (Spinner)findViewById(R.id.spinner_cources);

        List<CourseInfo> courseInfos=DataManager.getInstance().getCourses();
        ArrayAdapter<CourseInfo> arrayAdapterCouses= new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,courseInfos);
        arrayAdapterCouses.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerCourses.setAdapter(arrayAdapterCouses);
    ...
    private void createNewNote() {
        ...
        note=dm.getNotes().get(newPosition);
    }
